...
Redirect the user to the Dida365 authorization page, [登录 - 滴答清单](https://dida365.com/oauth/authorize). The required parameters are as follows:
...
Example:  
[登录 - 滴答清单](https://dida365.com/oauth/authorize?scope=scope&client_id=client_id&state=state&redirect_uri=redirect_uri&response_type=code)
